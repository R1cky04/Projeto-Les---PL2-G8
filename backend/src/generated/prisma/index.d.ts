...
export namespace Prisma {
  ...
  */
  ...
  type GetStationGroupByPayload<T extends StationGroupByArgs> =
  ...
  type StationGetPayload<S extends boolean | null | undefined | StationArgs> =
    $Types.GetResult<StationPayload, S>;
  ...
  > {
     ...
     **/
    findUnique<
      T extends StationFindUniqueArgs<ExtArgs>,
    ...
    > extends True
      ? Prisma__StationClient<
          $Types.GetResult<StationPayload<ExtArgs>, T, 'findUnique', never>,
          never,
          ExtArgs
        >
      : Prisma__StationClient<
          $Types.GetResult<
            StationPayload<ExtArgs>,
            T,
            'findUnique',
            never
          > | null,
    ...
    findUniqueOrThrow<T extends StationFindUniqueOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<StationPayload<ExtArgs>, T, 'findUniqueOrThrow', never>,
      never,
      ExtArgs
    >;
     ...
     **/
    findFirst<
      T extends StationFindFirstArgs<ExtArgs>,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? Prisma__StationClient<
          $Types.GetResult<StationPayload<ExtArgs>, T, 'findFirst', never>,
          never,
          ExtArgs
        >
      : Prisma__StationClient<
    ...
    findFirstOrThrow<T extends StationFindFirstOrThrowArgs<ExtArgs>>(
      ...
      $Types.GetResult<StationPayload<ExtArgs>, T, 'findFirstOrThrow', never>,
      never,
      ExtArgs
    >;
    ...
    findMany<T extends StationFindManyArgs<ExtArgs>>(
      ...
      $Types.GetResult<StationPayload<ExtArgs>, T, 'findMany', never>
    >;
    ...
    create<T extends StationCreateArgs<ExtArgs>>(
      ...
      $Types.GetResult<StationPayload<ExtArgs>, T, 'create', never>,
      never,
      ExtArgs
    >;
    ...
    delete<T extends StationDeleteArgs<ExtArgs>>(
      ...
      $Types.GetResult<StationPayload<ExtArgs>, T, 'delete', never>,
      never,
      ExtArgs
    >;
    ...
    update<T extends StationUpdateArgs<ExtArgs>>(
      ...
      $Types.GetResult<StationPayload<ExtArgs>, T, 'update', never>,
      never,
      ExtArgs
    >;
    ...
    upsert<T extends StationUpsertArgs<ExtArgs>>(
      ...
      $Types.GetResult<StationPayload<ExtArgs>, T, 'upsert', never>,
      never,
      ExtArgs
    >;
   ...
   */
  export class Prisma__StationClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
   ...
   * Station findUnique
   */
  export interface StationFindUniqueArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  > extends StationFindUniqueArgsBase<ExtArgs> {
    /**
   ...
   * Station findFirst
   */
  export interface StationFindFirstArgs<
    ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs,
  > extends StationFindFirstArgsBase<ExtArgs> {
    /**
     * Throw an Error if query returns no results
